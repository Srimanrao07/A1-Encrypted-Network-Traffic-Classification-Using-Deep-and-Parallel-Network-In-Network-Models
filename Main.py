...
main = tkinter.Tk()
main.title("Deep and parallel network in network models for accurate encrypted network traffic classification") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Deep and parallel network in network models for accurate encrypted network traffic classification ')
